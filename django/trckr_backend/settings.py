"""
Django settings for trckr_backend project.
...
SECRET_KEY = '+&_61z^3m(83-+-n+#y3#$kfc$oblbmm6+@v2^8od-vt0!575f'
...
ROOT_URLCONF = 'trckr_backend.urls'
...
WSGI_APPLICATION = 'trckr_backend.wsgi.application'
